                    ...
                    <form action="{{ URL::route('transportation.update.save' , $data->id) }}" method="post" class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="driver_contact" value="{{ $data->driver_contact }}" required>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="col-md-12">
                                ...
                                <textarea rows="7" class="form-control" name="notes">{{ $data->notes }}</textarea>
